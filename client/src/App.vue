...
<template>
  <div class="relative flex-col justify-center items-center h-full">
    <!-- Lobby -->
    ...
    <footer class="absolute bottom-0">
      <a
        class="flex gap-1 justify-center items-center h-8"
        href="https://github.com/AlliesChen/vue-chatroom"
        target="_blank"
      >
        <svg class="h-8" viewBox="0 0 128 128">
          <g fill="#00000">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
